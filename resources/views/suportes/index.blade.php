                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-bordered mt-4 mb-4" id="suporteTable">
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="editModal{{ $suporte->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $suporte->id }}" aria-hidden="true">
                                                ...
                                                <form action="{{ route('suportes.update', $suporte->id) }}" method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="nome_cliente" class="fw-bold">Nome do
                                                            Cliente</label>
                                                        <input type="text" name="nome_cliente" id="nome_cliente" value="{{ old('nome_cliente', $suporte->nome_cliente) }}" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="telefone_cliente" class="fw-bold">Telefone do
                                                            Cliente</label>
                                                        <input type="text" name="telefone_cliente" id="telefone_cliente" value="{{ old('telefone_cliente', $suporte->telefone_cliente) }}" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email_cliente" class="fw-bold">Email do
                                                            Cliente</label>
                                                        <input type="text" name="email_cliente" id="email_cliente" value="{{ old('email_cliente', $suporte->email_cliente) }}" class="form-control">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="descricao" name="descricao" rows="3">{{ $suporte->descricao }}</textarea>
                                                    </div>
                                ...
                                <div class="modal fade" id="deleteModal{{ $suporte->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $suporte->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                                <form action="{{ route('suportes.delete', $suporte->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
