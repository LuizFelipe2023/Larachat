...
<link rel="stylesheet" href="{{ asset('css/suporteForm.css') }}">
<script defer>
        ...
        <div class="col-md-12 mt-5 mb-5">
            ...
            <div class="card rounded-2 shadow-sm border-1 mb-3">
                <div class="card-header">
                    <h5 class="fw-bold mt-2 mb-2">Mensagem #{{ $suporte->id }} do {{ $suporte->nome_cliente }}</h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        @if ($errors->any())
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button type="button" class="btn btn-md btn-secondary" data-bs-toggle="modal" data-bs-target="#inserirAvaliacao{{ $suporte->id }}">
                                Avaliar
                            </button>
                            <a href="{{ route('home') }}" class="btn btn-md btn-warning">Voltar para home</a>
                        </div>
